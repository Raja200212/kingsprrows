...
export default function Portfolio() {
  ...
  const projects = [
    {
      ...
      gradient: 'linear-gradient(135deg, #b89047 0%, #0d2240 100%)',
    ...
    },
    {
      ...
      gradient: 'linear-gradient(135deg, #d4af37 0%, #b89047 100%)',
    ...
    },
    {
      ...
      gradient: 'linear-gradient(135deg, #0d2240 0%, #064e3b 100%)',
  ...
  return (
    <section id="portfolio" style={{ borderTop: '1px solid rgba(184, 144, 71, 0.15)', background: 'transparent' }}>
          ...
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div style={{
                ...
                alignItems: 'center',
                borderBottom: '1px solid rgba(184, 144, 71, 0.15)',
                paddingBottom: '16px'
              }}>
                ...
                <div style={{ display: 'flex', gap: '6px' }}>
                  <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: 'rgba(184, 144, 71, 0.25)' }} />
                  <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: 'rgba(184, 144, 71, 0.25)' }} />
                  <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: 'rgba(184, 144, 71, 0.25)' }} />
                </div>
              </div>
